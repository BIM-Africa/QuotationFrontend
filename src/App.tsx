    ...
    <span className="text-black text-xs sm:text-sm font-medium px-1 sm:px-2">FR</span>
      ...
      <div className="md:hidden z-50 relative">
        ...
        <img
          ...
          alt=""
        />
{/* Main content */} <div className=" relative z-10 flex justify-center items-start px-2 pt-0 pb-0 -mt-10 /* 📱 mobile: pull up more */ sm:-mt-4 /* 📱 sm: thoda kam */ md:mt-0 /* 💻 md+: reset so footer stays fine */ md:-translate-y-4 /* 💻 md: subtle pull */ lg:-translate-y-8 /* 🖥 lg: a bit more */ " > <QuotationTool /> </div>
        ...
        <div className="block sm:hidden">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-start mb-6">
              ...
              <button
  onClick={handleWhatsAppClick}
  className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap"
>
  JOIN NOW
</button>
        ...
        <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="text-left">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-4 sm:mt-6">
              <button
  onClick={handleWhatsAppClick}
  className="bg-[#333333] border border-transparent hover:border-[#ff1f00] text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-full font-medium whitespace-nowrap text-xs sm:text-sm lg:text-base"
>
  JOIN NOW
</button>
